          ...
          <div className="card bg-white shadow py-3">
            <div className="card-header">
              <img
                ...
                src={require('../assets/shegeft_1.png')}
                alt="bestSellers"
              />
              <span className="timeZoneElement badge badg-pill p-2 bg-primary d-none d-sm-inline">
                دقیقه<span className="mx-2">{timeZone.getMinutes()}</span> :ساعت{' '}
